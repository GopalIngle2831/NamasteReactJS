...
//Loop through filteredRestaurant array
//For each restaurant, create a Link to /restaurants/{restaurant.id}
//restaurant.id is passed as resId to the RestaurantMenu route
//Clicking the card navigates to that restaurant's menu page
