...
const RestaurantCard = (props) => { 
    ...
    //useContext reads the current value from UserContext.
    //It gives this component access to the data provided by UserContext.Provider (or default value if no Provider is used).
